...
//! Los argumentos se parsean a mano a propósito: dos subcomandos no
//! justifican una dependencia de CLI. Códigos de salida: 0 bien; 1 uso o
//! argumentos inválidos; 2 la migración falló o la verificación no pasó.

use nopaldb::migrate::{engine_name, migrate, parse_engine, parse_profile, render_report};
use nopaldb::{Storage, StorageEngine, StorageProfile};
